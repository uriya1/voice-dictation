...
1. Install dependencies (`whisper-cpp`, `ffmpeg`) via Homebrew
...
launchctl load ~/Library/LaunchAgents/com.voicedictation.hotkey.plist

# Stop
launchctl unload ~/Library/LaunchAgents/com.voicedictation.hotkey.plist
```
...
| `AUDIO_DEVICE` | `:1` | ffmpeg avfoundation device index |
